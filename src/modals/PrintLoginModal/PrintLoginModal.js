...
function render ({props}) {
  ...
  return (
    <Modal mt='0' w='800px' onDismiss={closeModal} pb='s'>
      <Block p bg='grey' align='space-between'>
...
function InfoBlock ({props}) {
  ...
  return (
    <Block borderBottom={!last && '1px dashed grey_medium'} pageBreakInside='avoid'>
      <Block border='1px solid grey_medium' align='start center' borderRadius='10' m p>
        <Block fs='l' color='blue' flex='35%' align='center center'>
          {user.displayName}
        </Block>
        <Block tag='ol' fs='s'>
          <Block tag='li' mb='s'>
          ...
          <Block tag='li'>
            ...
            <Block align='start center' mt='s'>
              <Text bold flex='50%'>username:</Text>
              <Text fontFamily='monospace'>{user.username}</Text>
            </Block>
            <Block align='start center'>
              <Text bold flex='50%'>password:</Text>
